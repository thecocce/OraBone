...
type
  ...
  private
    ...
    procedure InsertStatementOutput( {SynEdit: TSynEdit;} SList: TStringList; OraQuery: TOraQuery);
    procedure CSVFileOutput({SynEdit: TSynEdit;} SList: TStringList; OraQuery: TOraQuery; AddHeader: Boolean);
  public
    { Public declarations }
