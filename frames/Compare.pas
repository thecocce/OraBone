...
uses
  ...
  Diff, Vcl.Dialogs, Grids, Vcl.ExtCtrls, Vcl.StdCtrls, JvExStdCtrls, Vcl.Mask, JvExMask, JvToolEdit,
  Vcl.Buttons, JvExControls, JvSpeedButton, BCEdit, JvStringGrid, BCStringGrid,
  ActnList, JvScrollBar, JvExForms, JvExExtCtrls, JvSplitter, JvExtComponent,
  JvContentScroller, JvExGrids, JvEdit, JvCombobox, BCComboBox, BCFilenameEdit;
...
begin
  ...
  FName := System.SysUtils.StringReplace(Filename, '"', '', [rfReplaceAll]);
  if Trim(FName) = '' then
    Exit;
