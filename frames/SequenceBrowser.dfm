object SequenceBrowserFrame: TSequenceBrowserFrame
  Left = 0
  Top = 0
  Width = 451
  Height = 304
  ...
  ParentCtl3D = False
  TabOrder = 0
  object SequencePageControl: TBCPageControl
    Left = 0
    Top = 0
    Width = 451
    Height = 304
    ...
    object InfoTabSheet: TTabSheet
      ...
      object SequencePanel: TPanel
        ...
        Padding.Bottom = 1
        TabOrder = 0
        object SequenceDBGrid: TBCDBGrid
          Left = 0
          Top = 0
          Width = 441
          Height = 253
  ...
  object SequenceQuery: TOraQuery
    SQL.Strings = (
      ...
      '       min_value "Min Value", '
        ...
        '       DECODE(max_value, 1E27,'#39'999999999999999999999999999'#39', max' +
        '_value) "Max Value", '
      '       increment_by "Increment By", '
      '       cache_size "Cache Size", '
      '       DECODE(cycle_flag, '#39'N'#39', '#39'No'#39', '#39'Yes'#39') "Cycle",'
      '       DECODE(order_flag, '#39'N'#39', '#39'No'#39', '#39'Yes'#39') "Order"'
      '  FROM all_sequences'
      ' WHERE sequence_name = :p_object_name'
      '   AND sequence_owner = :p_owner')
    FetchAll = True
    ReadOnly = True
    AutoCommit = False
    AfterOpen = SequenceQueryAfterOpen
    Left = 208
    Top = 52
    ParamData = <
      item
