...
const
  ...
  IMG_IDX_TABLE_ROOT = 1;
  IMG_IDX_TABLE_CHILD = 2;
  IMG_IDX_VIEW_ROOT = 3;
  IMG_IDX_VIEW_CHILD = 4;
  IMG_IDX_FUNCTION_ROOT = 5;
  IMG_IDX_FUNCTION_CHILD = 6;
  IMG_IDX_PROCEDURE_ROOT = 7;
  IMG_IDX_PROCEDURE_CHILD = 8;
  IMG_IDX_PACKAGE_ROOT = 9;
  IMG_IDX_PACKAGE_CHILD = 10;
  IMG_IDX_TRIGGER_ROOT = 11;
  IMG_IDX_TRIGGER_CHILD = 12;
  IMG_IDX_CONSTRAINT_ROOT = 13;
  IMG_IDX_CONSTRAINT_CHILD = 14;
  IMG_IDX_INDEX_ROOT = 15;
  IMG_IDX_INDEX_CHILD = 16;
  IMG_IDX_SEQUENCE_ROOT = 17;
  IMG_IDX_SEQUENCE_CHILD = 18;
  IMG_IDX_SYNONYM_ROOT = 19;
  IMG_IDX_SYNONYM_CHILD = 20;
  IMG_IDX_DBLINK_ROOT = 21;
  IMG_IDX_DBLINK_CHILD = 22;
  IMG_IDX_INVALID_OBJECT_ROOT = 23;
  IMG_IDX_INVALID_OBJECT_CHILD = 24;
  IMG_IDX_RECYCLE_BIN_ROOT = 25;
  ...
  IMG_IDX_COMPILE = 34;
  IMG_IDX_FLASHBACK = 35;
  IMG_IDX_PURGE = 36;
  IMG_IDX_ANALYZE_TABLE = 37;
  IMG_IDX_ENABLE = 38;
  IMG_IDX_DISABLE = 39;
  IMG_IDX_USER_ROOT = 40;
  IMG_IDX_USER_CHILD = 41;
  IMG_IDX_LOCKED = 42;
  IMG_IDX_EXPIRED_AND_LOCKED = 43;
  IMG_IDX_TABLE_DROP = 44;
  IMG_IDX_VIEW_DROP = 45;
  IMG_IDX_FUNCTION_DROP = 46;
  IMG_IDX_PROCEDURE_DROP = 47;
  IMG_IDX_PACKAGE_DROP = 48;
  IMG_IDX_TRIGGER_DROP = 49;
  IMG_IDX_CONSTRAINT_DROP = 50;
  IMG_IDX_INDEX_DROP = 51;
  IMG_IDX_SEQUENCE_DROP = 52;
  IMG_IDX_SYNONYM_DROP = 53;
  IMG_IDX_DBLINK_DROP = 54;
  IMG_IDX_USER_DROP = 55;
  IMG_IDX_TABLE_CREATE = 56;
  IMG_IDX_VIEW_CREATE = 57;
  IMG_IDX_FUNCTION_CREATE = 58;
  IMG_IDX_PROCEDURE_CREATE = 59;
  IMG_IDX_PACKAGE_CREATE = 60;
  IMG_IDX_TRIGGER_CREATE = 61;
  IMG_IDX_CONSTRAINT_CREATE = 62;
  IMG_IDX_INDEX_CREATE = 63;
  IMG_IDX_SEQUENCE_CREATE = 64;
  IMG_IDX_SYNONYM_CREATE = 65;
  IMG_IDX_DBLINK_CREATE = 66;
  IMG_IDX_USER_CREATE = 67;
  IMG_IDX_CUSTOMIZE = 68;
  IMG_IDX_ALTER_VIEW = 69;
